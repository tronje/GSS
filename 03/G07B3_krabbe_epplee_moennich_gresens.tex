...
\section{Timing-Attack}
    \begin{itemize}
        ...
        \item 3.
            Zunächst versucht der Angreifer, die Länge des Passworts herauszufinden. 
        \item 4.
    \end{itemize}
\end{document}
